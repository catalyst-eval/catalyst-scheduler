...
export enum RulePriority {
  ...
  B5_SECONDARY_OLDER = 74, // B-5 Secondary for 11-15 year olds
  C1_SECONDARY_YOUNG = 73, // C-1 Secondary for young children ≤10
  B2_TERTIARY_ALL = 72, // B-2 Tertiary for all children ≤15
  ADULTS = 70,
